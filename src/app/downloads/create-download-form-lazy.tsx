...
function CreateDownloadFormStub() {
	return (
		...
		>
			<div className="h-6 w-40 animate-pulse rounded-lg bg-[var(--surface)]/[0.08]" />
			<div className="h-10 w-full animate-pulse rounded-lg bg-[var(--surface)]/[0.05]" />
			<div className="grid gap-4 sm:grid-cols-2">
				<div className="h-12 animate-pulse rounded-lg bg-[var(--surface)]/[0.05]" />
				<div className="h-12 animate-pulse rounded-lg bg-[var(--surface)]/[0.05]" />
			</div>
			...
			<div className="h-10 w-32 animate-pulse rounded-2xl bg-[var(--surface)]/[0.05]" />
		</div>
	);
}
