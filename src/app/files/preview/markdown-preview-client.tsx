...
export function MarkdownPreviewClient({ href }: { href: string }) {
	...
	return (
		<div className="overflow-auto rounded-2xl bg-[var(--surface)] p-4">
			...
			{/* Rendered markdown */}
			<div
				className="prose prose-invert max-w-none text-sm leading-relaxed [&_a]:text-[var(--color-action)] [&_a]:underline [&_a:hover]:text-[var(--color-action)] [&_blockquote]:border-l-4 [&_blockquote]:border-slate-600 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:text-[var(--text-secondary)] [&_code]:rounded [&_code]:bg-[var(--surface)] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:text-[var(--color-action)] [&_h1]:mt-6 [&_h1]:mb-3 [&_h1]:text-2xl [&_h1]:font-bold [&_h1]:text-[var(--text-primary)] [&_h2]:mt-5 [&_h2]:mb-2 [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-[var(--text-primary)] [&_h3]:mt-4 [&_h3]:mb-2 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-[var(--text-primary)] [&_h4]:mt-3 [&_h4]:mb-1.5 [&_h4]:text-base [&_h4]:font-semibold [&_h4]:text-[var(--text-primary)] [&_h5]:mt-3 [&_h5]:mb-1 [&_h5]:text-sm [&_h5]:font-semibold [&_h5]:text-[var(--text-primary)] [&_h6]:mt-3 [&_h6]:mb-1 [&_h6]:text-sm [&_h6]:font-semibold [&_h6]:text-[var(--text-secondary)] [&_hr]:border-slate-700 [&_hr]:my-4 [&_li]:text-[var(--text-primary)] [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:my-2 [&_p]:my-2 [&_p]:text-[var(--text-primary)] [&_pre]:rounded-xl [&_pre]:bg-[var(--surface)] [&_pre]:p-4 [&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre]:border [&_pre]:border-slate-800 [&_strong]:text-[var(--text-primary)] [&_strong]:font-semibold [&_table]:w-full [&_table]:my-3 [&_table]:border-collapse [&_td.align-center]:text-center [&_td.align-right]:text-right [&_td]:border [&_td]:border-slate-700 [&_td]:px-3 [&_td]:py-2 [&_td]:text-[var(--text-primary)] [&_th.align-center]:text-center [&_th.align-right]:text-right [&_th]:border [&_th]:border-slate-700 [&_th]:bg-[var(--surface)] [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_th]:font-semibold [&_th]:text-[var(--text-primary)] [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:my-2"
