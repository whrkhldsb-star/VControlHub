        ...
        {isSftp ? (
          <>
            <label className="grid gap-2 text-sm text-[var(--text-secondary)]">
              ...
              <select name="serverId" className="rounded-2xl border border-[var(--danger-border)] bg-[var(--input-bg)] px-4 py-3 text-[var(--text-primary)]">
            ...
            <label className="grid gap-2 text-sm text-[var(--text-secondary)]">
              ...
              <input name="host" className="rounded-2xl border border-[var(--danger-border)] bg-[var(--input-bg)] px-4 py-3 text-[var(--text-primary)]" placeholder={t("storagePage.form.hostPlaceholder")} />
            </label>
            <label className="grid gap-2 text-sm text-[var(--text-secondary)]">
