...
| 模块 | 功能不足（摘要） |
|---|---|
| **工单 Tickets** | 缺 SLA、升级策略、与 VPS/命令/审批的强关联、看板与高级过滤 |
| **AI 助手** | 缺稳定「工具调用编排放全站能力」、知识库/RAG、会话与运维对象（某机/某任务）深度绑定 |
| **AI Ops** | 自动闭环、可解释报告、与告警/Playbook 联动可加强 |
...
**待后续**：FEAT-P0-2（远程 Docker）、FEAT-P0-4（文件全文检索/版本历史）、FEAT-P1 其余项（AI 工具编排、告警远程统一、成本自动归集）。
