	...
	return withApiRoute(
		...
		async ({ session, body }) => {
			...
			try {
				...
				auditUserAction(session.userId, "vps-backup.schedule.update", { serverId, scheduleId });
	...
	return withApiRoute(
		...
		async ({ session }) => {
			...
			try {
				...
				auditUserAction(session.userId, "vps-backup.schedule.delete", { serverId, scheduleId });
