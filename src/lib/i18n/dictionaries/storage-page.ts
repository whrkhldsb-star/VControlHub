...
export const zh: Record<string, string> = {
	...
	"storagePage.form.sftpEndpointHint": "SFTP 终点二选一：绑定现有 VPS，或填写远端主机（至少填一项）。",
	"storagePage.form.sftpEndpointEitherOr": "请绑定 VPS 或填写远端主机（至少一项）",
	...
	"storagePage.form.defaultLockedHint": "默认节点的驱动和默认状态已锁定；如需迁移，请先把另一个节点设为默认。",
...
export const en: Record<string, string> = {
	...
	"storagePage.form.sftpEndpointHint": "SFTP endpoint: bind an existing VPS or enter a remote host (at least one).",
	"storagePage.form.sftpEndpointEitherOr": "Bind a VPS or enter a remote host (at least one)",
	...
	"storagePage.form.defaultLockedHint": "The default node's driver and default status are locked. Set another node as default before migrating.",
