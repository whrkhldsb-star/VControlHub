	...
	if (!confirming) {
		return (
			<button
				...
				title="删除"
				data-tone="rose" className="inline-flex items-center justify-center w-11 h-11 rounded-lg border border-rose-400/30 text-rose-100 transition hover:bg-rose-400/20"
			>
