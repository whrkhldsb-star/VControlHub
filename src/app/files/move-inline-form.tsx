    ...
    <form action={formAction} className="flex flex-wrap items-center gap-2">
      ...
      <label className="grid gap-1 text-sm text-[var(--text-secondary)]">
        ...
        <input
          ...
          className="rounded-2xl border border-[var(--border)] bg-slate-950 px-3 py-1.5 text-xs text-white placeholder:text-slate-500 light:placeholder:text-slate-400 focus:border-cyan-400/50 focus:outline-none"
        />
      </label>
