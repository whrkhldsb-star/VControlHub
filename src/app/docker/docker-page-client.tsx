	...
	return (
		<PageShell maxW="max-w-7xl">
			...
			{loading ? (
				...
				<div data-empty-state className="bg-[var(--surface)]/[0.02]">
					{t("dockerPage.empty")}
				</div>
			) : (
			...
			{pendingRemoval && (
				<div className="fixed inset-0 z-50 flex items-end justify-center overflow-y-auto bg-black/60 p-0 backdrop-blur-sm sm:items-center sm:p-4" role="presentation" onClick={closeRemovalDialog}>
					<div
						...
						className="w-full max-w-md mx-0 rounded-t-2xl border border-rose-400/20 bg-[var(--modal-bg)] p-5 shadow-2xl sm:mx-4 sm:rounded-2xl"
					...
					>
						...
						<div className="mt-5 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
							<button
								...
								className="min-h-11 rounded-lg border border-[var(--border)] px-3 py-1.5 text-xs text-[var(--text-secondary)] transition hover:bg-[var(--surface)]/[0.06]"
							>
					...
					>
						<div className="flex items-center justify-between mb-3">
							...
							<button
								...
								className="min-h-11 min-w-11 rounded-lg p-1 text-[var(--text-muted)] transition hover:bg-[var(--surface)]/[0.06] hover:text-[var(--text-secondary)] light:hover:bg-slate-100 light:hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-cyan-400/70"
							>
