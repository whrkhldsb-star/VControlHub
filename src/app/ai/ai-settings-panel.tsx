      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="col-span-2 md:col-span-2 relative">
          ...
          <div className="relative mt-1">
            <button
              ...
              className="w-full flex items-center justify-between bg-black/30 light:bg-slate-900/30 border border-white/10 light:border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-white hover:border-cyan-400/30 transition"
            >
        ...
        <div>
          ...
          <select
            ...
            className="w-full mt-1 bg-black/30 light:bg-slate-900/30 border border-white/10 light:border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-white"
          >
 ...
 {/* Save button */}
      ...
      <div className="mt-3">
        ...
        <textarea
          ...
          className="w-full mt-1 bg-black/30 light:bg-slate-900/30 border border-white/10 light:border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-white placeholder-slate-600 resize-none focus:outline-none focus:border-cyan-400/30"
        />
      </div>
    </div>
  );
