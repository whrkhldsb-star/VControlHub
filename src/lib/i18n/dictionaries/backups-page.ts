...
export const zh: Record<string, string> = {
	...
	"backupsPage.schedule.deleteConfirm": "确认删除此备份计划？已生成的备份记录不会被删除。",
...
export const en: Record<string, string> = {
	...
	"backupsPage.schedule.deleteConfirm": "Delete this backup schedule? Existing backup records will not be deleted.",
