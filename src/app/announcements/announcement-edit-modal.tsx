        ...
        <div className="mt-4 space-y-3">
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              className="mt-1 w-full rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-sm text-slate-300 outline-none focus:border-cyan-400/50 light:border-slate-200 light:bg-slate-50 light:text-slate-900"
            />
          </div>
