...
Generated: 2026-06-16T11:03:03.309Z
...
| `total-mismatch` | error | — | — | top-level total_tasks=57 but tasks.length is 58 |
...
| `0918df1` | docs(readme): TR-037 R7 (T38c) ai 域 8 路由 zod 迁移 + chatSchema bug fix 落地 |
| `16126d9` | refactor(ai): TR-037 R7 ai 域 9 路由 zod 迁移 + 修 chatSchema 实际 client payload 不匹配 bug + audit 脚本支持多 boundary (T38c) |
