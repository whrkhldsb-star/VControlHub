...
function adviceToneClass(tone: "emerald" | "amber" | "rose" | undefined) {
	if (tone === "emerald") {
		return "border-[var(--success-border)] bg-[var(--success-bg)] light:border-[var(--success-border)] light:bg-[var(--success-bg)]";
	}
	if (tone === "rose") {
		return "border-[var(--danger-border)] bg-[var(--danger-bg)] light:border-[var(--danger-border)] light:bg-[var(--danger-bg)]";
	}
	// amber (default) 与原版一致
