...
- **测试增量**：1303 (R17) → 1316 (R21) → **1377 (R22)** → 1420 (R18)，共 **+117 tests**，测试文件 222 → 255。R18 在 R17 mobile touch target 模式上向 snippets 子模块扩展（+4 tests，1420 总），模式同 R7-R17 续做；R22 7-domain test coverage +74 仍是当前基线。
