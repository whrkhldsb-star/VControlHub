        ...
        <div className="mt-4 grid gap-4 xl:grid-cols-2">
          <div className="rounded-xl border border-white/[0.05] bg-slate-950/40 p-4">
            <div className="flex items-center justify-between gap-3">
              <h3 className="text-sm font-medium text-white/80">{t("dashboard.analytics.server-trend")}</h3>
          ...
          <div className="rounded-xl border border-white/[0.05] bg-slate-950/40 p-4">
            <h3 className="text-sm font-medium text-white/80">{t("dashboard.analytics.download-trend")}</h3>
          ...
          <div className="rounded-xl border border-white/[0.05] bg-slate-950/40 p-4">
            <h3 className="text-sm font-medium text-white/80">{t("dashboard.analytics.audit-activity")}</h3>
            {data.audit?.length ? (
          ...
          <div className="rounded-xl border border-white/[0.05] bg-slate-950/40 p-4">
            <h3 className="text-sm font-medium text-white/80">{t("dashboard.analytics.image-bed")}</h3>
