...
export function MobileNav() {
	...
	return (
		<nav
			aria-label="移动端底部导航"
			data-i18n-skip
			className="fixed bottom-0 left-0 right-0 z-50 overflow-x-auto border-t border-white/[0.06] bg-slate-950/95 px-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2 backdrop-blur-xl md:hidden max-[360px]:px-1 light:shadow-[0_-10px_30px_rgba(15,23,42,0.08)]"
		>
