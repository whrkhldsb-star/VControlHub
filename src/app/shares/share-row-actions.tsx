		...
		<div className="flex items-center gap-2">
			{!revoked ? (
				<button
					...
					disabled={busy}
					className="min-h-11 min-w-11 rounded-md border border-rose-400/30 bg-rose-400/10 px-2.5 py-1 text-xs text-rose-100 transition hover:bg-rose-400/20 disabled:cursor-not-allowed disabled:opacity-50"
				>
					{busy ? "撤销中…" : "撤销"}
				</button>
			) : (
