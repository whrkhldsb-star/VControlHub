...
function ActionButton({ href, label, icon, variant = "default" }: {
	href: string; label: string;
	icon: React.ReactNode;
	variant?: "default" | "primary" | "danger";
}) {
	const base = "inline-flex items-center gap-2 rounded-xl px-3.5 py-2 text-sm font-medium transition-all duration-200 border";
	const styles = {
		default: "border-white/10 bg-white/5 text-slate-200 hover:bg-white/10 hover:border-white/20 hover:text-white",
		primary: "border-cyan-400/30 bg-cyan-500/15 text-cyan-100 hover:bg-cyan-500/25 hover:border-cyan-400/50 hover:text-white",
		danger: "border-rose-400/30 bg-rose-500/15 text-rose-200 hover:bg-rose-500/25 hover:border-rose-400/50",
	}[variant];
	return (
