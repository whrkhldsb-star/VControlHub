...
export function MarkdownPreviewClient({ href }: { href: string }) {
	...
	return (
		<div className="overflow-auto rounded-2xl bg-slate-950 light:bg-white p-4">
			{/* Label */}
			<div className="mb-3 flex items-center gap-2">
				<span className="rounded-full border border-cyan-400/30 bg-cyan-400/10 px-3 py-1 text-xs text-cyan-300 light:text-cyan-700">
					Markdown 预览
				</span>
			</div>
