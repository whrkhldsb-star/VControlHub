/**
 * TR-053: /status page must match /api/status exposure rules.
 * Anonymous visitors only get overall summary; authenticated users get checks + uptime.
 */
...
describe("/status page TR-053 exposure", () => {
  beforeEach(() => {
  ...
  it("anonymous: summary only — no full checks, no uptime inventory", async () => {
