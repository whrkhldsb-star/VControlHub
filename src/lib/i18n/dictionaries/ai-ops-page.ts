...
export const zh: Record<string, string> = {
	...
	"aiOpsPage.actions.summaryFailed": "加载 AI 运维汇总失败",
	// Filters
	...
	"aiOpsPage.detail.executedActions": "已执行动作",
	"aiOpsPage.detail.executedActionsEmpty": "无已执行动作",
	"aiOpsPage.detail.notes": "备注",
	"aiOpsPage.detail.errorMessage": "错误信息",
	"aiOpsPage.detail.duration": "耗时",
	"aiOpsPage.detail.durationMs": "{ms} 毫秒",
	// Execute result messages
	"aiOpsPage.execute.requiresApproval": "需要管理员审批，不会自动执行",
	"aiOpsPage.execute.notInSafeSet": "该动作不在自主安全集合中，需人工执行",
	"aiOpsPage.execute.executed": "已执行",
	"aiOpsPage.execute.notFound": "推荐项不存在",
	"aiOpsPage.execute.logNotFound": "日志不存在",
...
export const en: Record<string, string> = {
	...
	"aiOpsPage.actions.cancel": "Cancel",
	...
	"aiOpsPage.actions.summaryFailed": "Failed to load AI ops summary",
	// Filters
	...
	"aiOpsPage.detail.executedActions": "Executed actions",
	"aiOpsPage.detail.executedActionsEmpty": "No executed actions",
	"aiOpsPage.detail.notes": "Notes",
	"aiOpsPage.detail.errorMessage": "Error message",
	"aiOpsPage.detail.duration": "Duration",
	"aiOpsPage.detail.durationMs": "{ms} ms",
	// Execute result messages
	"aiOpsPage.execute.requiresApproval": "Requires admin approval; will not auto-execute",
	"aiOpsPage.execute.notInSafeSet": "Action is not in the autonomous safe set; needs manual execution",
	"aiOpsPage.execute.executed": "Executed",
	"aiOpsPage.execute.notFound": "Recommendation not found",
	"aiOpsPage.execute.logNotFound": "Log not found",
	// Settings (placeholder — full settings UI is Tick 3)
