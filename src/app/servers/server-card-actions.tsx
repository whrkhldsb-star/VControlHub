          ...
          >
            ...
            <div className="space-y-2 rounded-xl border border-[var(--border)] bg-[var(--surface-subtle)] p-3">
              <label className="flex items-start gap-2 text-xs text-[var(--text-secondary)]">
                ...
                />
                <span>
                  <span className="block font-medium text-[var(--text-primary)]">{t("serverCardActions.edit.costAutoSync")}</span>
                  <span className="text-[11px] text-[var(--text-muted)]">{t("serverCardActions.edit.costHint")}</span>
                </span>
              </label>
