                ...
                <div className="flex items-center gap-2">
                  ...
                  {canManage && (
                    <div className="flex items-center gap-1 opacity-0 transition group-hover:opacity-100">
                      <button onClick={() => setEditing(a)} title={t("announcementsPage.action.edit")} aria-label={t("announcementsPage.action.edit")} className="rounded-lg p-1.5 text-[var(--text-muted)] hover:bg-[var(--surface)]/10 hover:text-[var(--color-action)]">
                        <Pencil size={14} />
                      </button>
