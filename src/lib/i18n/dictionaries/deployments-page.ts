...
export const zh: Record<string, string> = {
	...
	"deploymentsPage.launch.nodeSetupIncomplete": "节点初始化尚未完成，暂不可部署",
	"deploymentsPage.launch.nodeHealthFailed": "最近一次存储连通性检查失败，请先排查节点",
	"deploymentsPage.launch.nodeRecentlyOffline": "节点最近一次监控明确离线，请先检查连接",
	...
	"deploymentsPage.page.submitSuccess": "部署已提交，进入审批/执行链路。",
	...
	"deploymentsPage.page.exportSection": "迁移部署导出（按需展开）",
	...
	"deploymentsPage.page.status.nextApproval": "下一步：等待审批。",
	"deploymentsPage.page.status.nextExecution": "下一步：后台正在执行，请查看执行日志。",
	"deploymentsPage.page.status.nextDone": "流程已完成。",
	"deploymentsPage.page.status.nextFailed": "流程未完成，请检查错误并重发或回滚。",
	"deploymentsPage.page.status.nextUnknown": "状态处理中，请稍后刷新。",
	"deploymentsPage.page.status.viewApproval": "查看审批与执行记录",
	...
	"deploymentsPage.export.eyebrow": "便携导出",
...
export const en: Record<string, string> = {
	...
	"deploymentsPage.launch.nodeSetupIncomplete": "Node setup is incomplete and cannot receive deployments yet",
	"deploymentsPage.launch.nodeHealthFailed": "The latest storage connectivity check failed; troubleshoot the node first",
	"deploymentsPage.launch.nodeRecentlyOffline": "The latest monitor probe reports this node offline; check connectivity first",
	...
	"deploymentsPage.page.submitSuccess": "Deployment submitted and entered the approval/execute flow.",
	...
	"deploymentsPage.page.exportSection": "Migration deployment export (expand when needed)",
	...
	"deploymentsPage.page.status.nextApproval": "Next: waiting for approval.",
	"deploymentsPage.page.status.nextExecution": "Next: running in the background; check execution logs.",
	"deploymentsPage.page.status.nextDone": "The workflow is complete.",
	"deploymentsPage.page.status.nextFailed": "The workflow did not complete; inspect the error, resend, or roll back.",
	"deploymentsPage.page.status.nextUnknown": "Still processing; refresh shortly.",
	"deploymentsPage.page.status.viewApproval": "View approval and execution record",
	...
	"deploymentsPage.export.eyebrow": "Portable Export",
