...
const fieldClassName =
	"w-full rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-white shadow-[0_0_0_1px_rgba(255,255,255,0.05)] outline-none transition-all duration-150 placeholder:text-white/25 focus:border-cyan-400/50 focus:bg-white/[0.06] focus:ring-4 focus:ring-cyan-400/10 light:border-slate-200/80 light:bg-white light:text-slate-950 light:shadow-sm light:placeholder:text-slate-400 light:focus:border-cyan-500/70 light:focus:bg-white light:focus:ring-cyan-500/10";
		...
		<form action="/api/login" method="post" className="space-y-4">
			...
			<label className="flex items-center justify-between gap-3 rounded-2xl border border-white/[0.06] bg-white/[0.025] px-3.5 py-2.5 text-xs font-medium text-white/45 shadow-[0_0_0_1px_rgba(255,255,255,0.03)] light:border-slate-200/80 light:bg-slate-50 light:text-slate-600 light:shadow-sm">
				...
				<input
					type="checkbox"
					name="remember"
					className="h-4 w-4 rounded border-white/20 bg-white/[0.06] text-cyan-400 focus:ring-cyan-400/40 light:border-slate-300 light:bg-white light:text-cyan-500 light:focus:ring-cyan-500/30"
				/>
			</label>

			{error ? (
				<div role="alert" className="rounded-2xl border border-rose-400/15 bg-rose-500/[0.08] px-4 py-2.5 text-sm font-medium text-rose-200 shadow-[0_0_0_1px_rgba(251,113,133,0.08)] light:border-rose-200 light:bg-rose-50 light:text-rose-700 light:shadow-sm">
					{error}
				</div>
			) : null}
