...
export const zh: Record<string, string> = {
	...
	"backupsPage.schedule.error.noServer": "请选择至少一台执行备份的 VPS 节点",
	"backupsPage.schedule.nameTemplate": "定时{type}备份",
	"backupsPage.schedule.reasonTemplate": "由备份页面创建的{type}定时备份",
	"backupsPage.schedule.success": "定时备份任务已创建，可在定时任务页面查看下一次运行时间和执行日志。",
	"backupsPage.schedule.failFallback": "创建定时备份失败",
	"backupsPage.schedule.executeOn": "执行节点",
...
export const en: Record<string, string> = {
	...
	"backupsPage.schedule.error.noServer": "Please select at least one VPS node to run the backup",
	"backupsPage.schedule.nameTemplate": "Scheduled {type} backup",
	"backupsPage.schedule.reasonTemplate": "Scheduled {type} backup created from the backups page",
