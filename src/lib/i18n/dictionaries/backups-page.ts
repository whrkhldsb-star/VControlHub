...
export const zh: Record<string, string> = {
	...
	"backupsPage.schedule.error.noServer": "请输入有效的 Cron 表达式",
	...
	"backupsPage.schedule.executeOn": "执行频率",
	"backupsPage.schedule.empty": "暂无备份计划，在上方创建一个开始。",
...
export const en: Record<string, string> = {
	...
	"backupsPage.schedule.error.noServer": "Please enter a valid cron expression",
	...
	"backupsPage.schedule.executeOn": "Frequency",
	"backupsPage.schedule.empty": "No backup schedules yet — create one above.",
