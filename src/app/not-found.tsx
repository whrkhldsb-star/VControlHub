  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 light:bg-white px-6">
      <div className="max-w-md text-center">
        ...
        <Link
          href="/"
          className="mt-6 inline-block rounded-full border border-cyan-400/30 bg-cyan-400/10 px-6 py-2.5 text-sm font-medium text-cyan-100 light:text-cyan-900 transition hover:bg-cyan-400/20"
        >
          ← 返回首页
        </Link>
      </div>
