		...
		return (
			<PageShell>
				<section className="rounded-2xl border border-rose-400/20 bg-rose-400/[0.06] p-6">
					<h1 className="text-xl font-semibold text-rose-100 light:text-rose-900">缺少权限</h1>
					<p className="mt-2 text-sm text-rose-100/70 light:text-rose-900/70">需要 api-token:manage 权限才能管理个人 API Token。</p>
				</section>
			</PageShell>
		);
	}
	...
	return (
		<PageShell>
			<div className="mb-8 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
				<div>
					<p className="text-xs font-medium uppercase tracking-[0.24em] text-cyan-300 light:text-cyan-700/70">Access Tokens</p>
					<h1 className="mt-2 text-3xl font-semibold text-white light:text-slate-900">个人 API Token</h1>
					<p className="mt-2 max-w-3xl text-sm text-slate-400 light:text-slate-600">
