...
export const zh: Record<string, string> = {
	...
	"apiAiChat.invalidRequest": "无效请求",
	"apiAiChat.invalidInput": "输入参数无效",
	...
	"apiAiChat.unexpectedError": "意外错误",
};
...
export const en: Record<string, string> = {
	...
	"apiAiChat.invalidRequest": "Invalid request",
	"apiAiChat.invalidInput": "Invalid input parameters",
	...
	"apiAiChat.unexpectedError": "Unexpected error",
};
