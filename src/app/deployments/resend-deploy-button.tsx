	...
	return (
		<div className="flex flex-wrap items-center gap-2">
			<button
				...
				disabled={pending}
				className="rounded-lg border border-cyan-400/30 bg-cyan-400/10 px-3 py-1.5 text-xs font-medium text-cyan-200 light:text-cyan-800 transition hover:bg-cyan-400/15 disabled:cursor-not-allowed disabled:opacity-60"
			>
