	...
	return (
		...
		>
			<div className="flex flex-col gap-1">
				<div className="h-3 w-12 animate-pulse rounded bg-[var(--surface-elevated)]" />
				<div className="h-7 w-36 animate-pulse rounded-lg bg-[var(--surface-elevated)]" />
			</div>
			<div className="flex flex-col gap-1">
				<div className="h-3 w-12 animate-pulse rounded bg-[var(--surface-elevated)]" />
				<div className="h-7 w-24 animate-pulse rounded-lg bg-[var(--surface-elevated)]" />
			</div>
		</div>
	);
}
