...
describe("auth bootstrap", () => {
  it("keeps the initial admin username stable and requires password rotation", () => {
    expect(ADMIN_BOOTSTRAP.username).toBe("admin");
    expect(ADMIN_BOOTSTRAP.mustChangePassword).toBe(true);
    expect(ADMIN_BOOTSTRAP.status).toBe("PENDING_PASSWORD_RESET");
